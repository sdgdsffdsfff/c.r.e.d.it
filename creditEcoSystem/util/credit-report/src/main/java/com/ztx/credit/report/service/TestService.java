...
//		String urlBase = "http://10.2.129.102:8080/test/123/";
//		// 123/";
//long statr=System.currentTimeMillis();
//		for (int i = 205; i < 206; i++) {
//			String fileName = "12_.htm";
...
//				}
//			}
//			runDataTool(url, txtName);
//		}
//		long end=System.currentTimeMillis();
//		System.out.println(end-statr);
//	}
//
//	private static void runDataTool(String url, String txtName) {
//
//		long start = System.currentTimeMillis();
//		CreditHtmlAnalysisService creditReportService = new CreditHtmlAnalysisService();
//		creditReportService.setDriver(new HtmlUnitDriver());
//		creditReportService.getDriver().get(url);
//
//		try {
//			ReportHeadInfo reportHeadInfo = creditReportService
//					.getReportHeadInfo();
//
...
//			}
//		} catch (Exception e) {
//			FileUtil.AppendContent(txtName, "异常！报告头----没有数据\r\n");
//		}
//		try {
...
//			}
//		} catch (Exception e) {
//			FileUtil.AppendContent(txtName, "异常！被查询者信息----没有数据\r\n");
//		}
//
//		try {
...
//			}
//		} catch (Exception e) {
//			FileUtil.AppendContent(txtName, "异常！身份信息----没有数据\r\n");
//		}
//
//		try {
...
//			}
//		} catch (Exception e) {
//			FileUtil.AppendContent(txtName, "异常！配偶信息----没有数据\r\n");
//		}
//		try {
...
//			}
//		} catch (Exception e) {
//			FileUtil.AppendContent(txtName, "异常！居住信息----没有数据\r\n");
//		}
//
//		try {
...
//					FileUtil.AppendContent(txtName, "职业信息----"
//							+ personalCareerInfo.toString() + "\r\n");
//				}
//			}
//		} catch (Exception e) {
//			FileUtil.AppendContent(txtName, "异常！职业信息----没有数据\r\n");
//		}
//		try {
...
//		}} catch (Exception e) {
//			FileUtil.AppendContent(txtName, "异常！信用提示----没有数据\r\n");
//		}
//		
//		try {
...
//		}
//		} catch (Exception e) {
//			FileUtil.AppendContent(txtName, "异常！中征信评分----没有数据\r\n");
//		}
//		
//		try {
...
//		
//		} catch (Exception e) {
//			FileUtil.AppendContent(txtName, "异常！逾期及违约信息概要----没有数据\r\n");
//		}
//		
//		try {
...
//		
//		} catch (Exception e) {
//			FileUtil.AppendContent(txtName, "异常！逾期（透支）信息汇总----没有数据\r\n");
//		}
//		
//		try {
...
//		
//		} catch (Exception e) {
//			FileUtil.AppendContent(txtName, "异常！未结清贷款信息汇总----没有数据\r\n");
//		}
//		
//		try {
...
//		
//		} catch (Exception e) {
//			FileUtil.AppendContent(txtName, "异常！未销户贷记卡信息汇总----没有数据\r\n");
//		}
//		
//		try {
...
//		
//		} catch (Exception e) {
//			FileUtil.AppendContent(txtName, "异常！未销户准贷记卡信息汇总----没有数据\r\n");
//		}
//		
//		try {
...
//		
//		} catch (Exception e) {
//			FileUtil.AppendContent(txtName, "异常！对外担保信息汇总----没有数据\r\n");
//		}
//		
//		try {
...
//		}
//		} catch (Exception e) {
//			FileUtil.AppendContent(txtName, "异常！资产处置信息----没有数据\r\n");
//		}
//		
//		try {
...
//		
//		} catch (Exception e) {
//			FileUtil.AppendContent(txtName, "异常！保证人代偿信息----没有数据\r\n");
//		}
//		
//		try {
...
//		}
//		} catch (Exception e) {
//			FileUtil.AppendContent(txtName, "异常！贷款----没有数据\r\n");
//		}
//		
//		try {
...
//		}
//		} catch (Exception e) {
//			FileUtil.AppendContent(txtName, "异常！贷记卡----没有数据\r\n");
//		}
//		try {
...
//		}
//		} catch (Exception e) {
//			FileUtil.AppendContent(txtName, "异常！准贷记卡----没有数据\r\n");
//		}
//		
//		try {
...
//		}
//		} catch (Exception e) {
//			FileUtil.AppendContent(txtName, "异常！对外担保信息----没有数据\r\n");
//		}
//		try {
...
//		}
//		} catch (Exception e) {
//			FileUtil.AppendContent(txtName, "异常！欠税记录----没有数据\r\n");
//		}
//		try {
...
//		}
//		} catch (Exception e) {
//			FileUtil.AppendContent(txtName, "异常！民事判决记录----没有数据\r\n");
//		}
//		try {
...
//			}
//		}} catch (Exception e) {
//			FileUtil.AppendContent(txtName, "异常！强制执行记录----没有数据\r\n");
//		}
//		try {
...
//		}
//		} catch (Exception e) {
//			FileUtil.AppendContent(txtName, "异常！行政处罚记录----没有数据\r\n");
//		}
//		try {
...
//		}
//		} catch (Exception e) {
//			FileUtil.AppendContent(txtName, "异常！住房公积金参缴记录----没有数据\r\n");
//		}
//		
//		try {
...
//		}
//		} catch (Exception e) {
//			FileUtil.AppendContent(txtName, "异常！养老保险金缴存记录----没有数据\r\n");
//		}
//		try {
...
//		}
//		} catch (Exception e) {
//			FileUtil.AppendContent(txtName, "异常！养老保险金发放记录----没有数据\r\n");
//		}
//		try {
...
//		}
//		} catch (Exception e) {
//			FileUtil.AppendContent(txtName, "异常！低保救助记录----没有数据\r\n");
//		}
//		try {
...
//		}
//		} catch (Exception e) {
//			FileUtil.AppendContent(txtName, "异常！执业资格记录----没有数据\r\n");
//		}
//		
//		try {
...
//		}
//		} catch (Exception e) {
//			FileUtil.AppendContent(txtName, "异常！行政奖励记录----没有数据\r\n");
//		}
//		
//		try {
...
//		}
//		} catch (Exception e) {
//			FileUtil.AppendContent(txtName, "异常！车辆交易和抵押记录----没有数据\r\n");
//		}
//
//		try {
...
//		}
//		} catch (Exception e) {
//			FileUtil.AppendContent(txtName, "异常！电信缴费记录----没有数据\r\n");
//		}
//		
//		try {
...
//		}
//		} catch (Exception e) {
//			FileUtil.AppendContent(txtName, "异常！本人声明----没有数据\r\n");
//		}
//		
//		try {
...
//		
//		} catch (Exception e) {
//			FileUtil.AppendContent(txtName, "异常！异议标注----没有数据\r\n");
//		}
//		
//		try {
...
//		}
//		} catch (Exception e) {
//			FileUtil.AppendContent(txtName, "异常！查询记录汇总----没有数据\r\n");
//		}
//		
//		try {
...
//		}
//		} catch (Exception e) {
//			FileUtil.AppendContent(txtName, "异常！信贷审批查询记录明细----没有数据\r\n");
//		}
//		try {
