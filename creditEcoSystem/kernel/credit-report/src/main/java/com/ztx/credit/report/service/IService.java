...
public interface IService {
	 ...
	 * @throws Exception
	 */
	List<PersonalResidentialInfo> getPersonalResidentialInfos()
			throws Exception;
	 ...
	 * @throws Exception
	 */
	SummaryOverdueAndDefaultInfo getSummaryOverdueAndDefaultInfo()
			throws Exception;
	 ...
	 * @throws Exception
	 */
	List<AssertDisposeDetailInfo> getAssertDisposeDetailInfos()
			throws Exception;
	 ...
	 * @throws Exception
	 */
	List<GuarantorCompensationDetailInfo> getGuarantorCompensationDetailInfos()
			throws Exception;
	 ...
	 * @throws Exception
	 */
	List<AdministrativeRewardInfo> getAdministrativeRewardInfos()
			throws Exception;
	 ...
	 * @throws Exception
	 */
	List<VehicleTradeAndMortgageInfo> getVehicleTradeAndMortgageInfos()
			throws Exception;
	 ...
	 * @throws Exception
	 */
	List<DissentDeclareDetailInfo> getDissentDeclareDetailInfos()
			throws Exception;
