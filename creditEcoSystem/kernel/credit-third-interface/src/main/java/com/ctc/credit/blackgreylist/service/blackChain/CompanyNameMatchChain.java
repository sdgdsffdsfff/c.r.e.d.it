...
@Component
public class CompanyNameMatchChain extends IAbstractBlackMatchChain {
	...
	public Map<String, Object> doMatch(HandleRequest requestInfo) {
		...
		List<Map<String,Object>> matchResult = blkgrayListRoleServiceImpl.matchCompanyName(requestInfo.getCompanyName());
