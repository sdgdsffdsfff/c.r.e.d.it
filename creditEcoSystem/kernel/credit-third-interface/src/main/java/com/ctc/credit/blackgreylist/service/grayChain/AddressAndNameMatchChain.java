 ...
 */
@Component
public class AddressAndNameMatchChain  extends IAbstractGrayMatchChain {
	@Autowired
	...
	public List<Map<String, Object>> doMatch(HandleRequest requestInfo) {
		...
		List<Map<String,Object>> matchResult = blkgrayListRoleServiceImpl.matchAddressAndName(requestInfo.getAddressDetail(),requestInfo.getCustomerName());
