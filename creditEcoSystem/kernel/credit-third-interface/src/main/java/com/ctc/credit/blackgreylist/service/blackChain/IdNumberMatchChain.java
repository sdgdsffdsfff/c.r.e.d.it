...
@Component
public class IdNumberMatchChain extends IAbstractBlackMatchChain {
	...
	public Map<String,Object> doMatch(HandleRequest requestInfo) {
		...
		List<Map<String,Object>> matchResult = blkgrayListRoleServiceImpl.matchIdNumber(requestInfo.getCardNo());
