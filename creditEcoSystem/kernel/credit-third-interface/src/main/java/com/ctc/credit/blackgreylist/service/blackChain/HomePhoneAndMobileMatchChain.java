...
@Component
public class HomePhoneAndMobileMatchChain extends IAbstractBlackMatchChain {
	...
	public Map<String, Object> doMatch(HandleRequest requestInfo) {
		...
		List<Map<String,Object>> matchResult = blkgrayListRoleServiceImpl.matchHomePhoneAndMoble(requestInfo.getMobile(), requestInfo.getPhone());
...
//			Integer priority = Integer.parseInt(matchInfo.get("priority")+"");
