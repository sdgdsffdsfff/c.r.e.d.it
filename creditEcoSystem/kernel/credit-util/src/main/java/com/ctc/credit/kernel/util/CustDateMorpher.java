...
public class CustDateMorpher extends AbstractObjectMorpher {
	...
	private Date defaultValue;
	    ...
	    */
	   public CustDateMorpher( String[] formats )
	   {
	    ...
	    */
	   public CustDateMorpher( String[] formats, boolean lenient )
	   {
	    ...
	    */
	   public CustDateMorpher( String[] formats, Date defaultValue )
	   {
	    ...
	    * @param lenient if the parsing should be lenient or not.
	    */
	   public CustDateMorpher( String[] formats, Date defaultValue, Locale locale, boolean lenient )
	   {
	      super( true );
	    ...
	    * @param locale the Locale used to parse each format.
	    */
	   public CustDateMorpher( String[] formats, Locale locale )
	   {
	    ...
	    * @param lenient if the parsing should be lenient or not.
	    */
	   public CustDateMorpher( String[] formats, Locale locale, boolean lenient )
	   {
	      if( formats == null || formats.length == 0 ){
	         throw new MorphException( "invalid array of formats" );
	      }
	   ...
	   public boolean equals( Object obj )
	   {
	      ...
	      CustDateMorpher other = (CustDateMorpher) obj;
